...
`
var wordPattern = new RegExp(WORD, 'i')
var fullStopPattern = new RegExp(`
    (?<=[\\u1400-\\u167f])[.] |
    \\A[.]\\Z
`)
...
var transcodeSROWordToSyllabics = function (sroWord, hyphen, sandhi) {
...
var syllabics2sroLookup = (function () {
  let lookup = {}
...
Object.assign(syllabics2sroLookup, { 'ᐝ': 'y', '᙮': '.', 'ᑦ': 'm', 'ᕁ': 'hk', 'ᐩ': 'y', '\u202f': '-' })
var SYLLABICS_TO_SRO = _maketrans(syllabics2sroLookup)
...
var finalDotPattern = (function () {
  let withoutDot = Object.keys(SYLLABIC_WITH_DOT).join('')
  return new RegExp(`([${withoutDot}])ᐧ`)
}())
var circumflexToMacrons = _maketrans('êîôâ', 'ēīōā')
var syllabics2sro = function (syllabics, produceMacrons) {
